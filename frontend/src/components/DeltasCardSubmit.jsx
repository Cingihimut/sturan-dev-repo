...
import { deltaVenturesFunding, approveToken } from "../app/utils/fundCrowdfunding";
...
const DeltasCardSubmit = async({ onClose }) => {
    ...
    const handleSubmit = async () => {
        ...
        const crowdfundingAddress = "0x56E8561E577716585FCa7f90a60EE1856f9210AB"; //crowdfunding contract
    
        const contributorAmountInWei = Web3.utils.toWei(contributionAmount.toString(), "ether");
    
        try {
            await deltaVenturesFunding(contributionAmount);
...
export default DeltasCardSubmit;