      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        <div className="col-span-1 lg:col-span-3 pr-0 lg:pr-6">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <h1 className="text-xl lg:text-2xl font-semibold">Environmental maintenance</h1>
            <button className="py-2 px-4 lg:px-6 border-[2px] border-color-neutral rounded-full">Share</button>
          </div>
          <div className="mt-6">
            <h1 className="text-2xl lg:text-3xl font-bold">Lorem ipsum dolor sit amet, consectetur adipisicing elit🌎</h1>
